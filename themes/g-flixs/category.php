...
$sasaran = ucwords($dirname) . ' Movies';
include('header.php');
?>
<body id="lighy">
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
                <div class="topic">
                        <h3><?php echo $sasaran;?></h3>
                </div>
                <div class="row">
                    <div class="col-md-wrap">
                        <?php 
        $Movies = unserialize( gsilvers_data_genre('home_genre_'.$filename.'_',$filename,$page) );
        ...
        ?>
                ...
                if ($Movies['total_results'][0] > 19) :
                        ...
                        $limit  = 20; 
                        $link   = '/genre/?action=category&terms='.$dirname.'&id='.$filename;
