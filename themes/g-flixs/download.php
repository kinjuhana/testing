...
$dirname = str_replace('/register?movie=','',$urlPath);
...
<div class="title">You are opening the registration page<p></p>to download<span class="red"><?php echo $judul;?> Movies for Free</span></div>
