...
<div class="container">
    <div class="row">
        <div class="col-md-12">
                <div class="topic">
                        <h3><a title="<?php echo $newquery;?> movie"><?php echo $newquery;?> movie <i class="fa fa-angle-right ml-3" aria-hidden="true"></i></a></h3>
                </div>
                <div class="row">
                    <div class="col-md-wrap">
                        <?php 
        if ( empty( $_GET['page'] ) ) { $page = 1; }else{ $page = $_GET['page']; }
        $Movies = unserialize( gsilvers_data_search_movie(limit_word($newquery, 3),$page) );
        ...
        ?>
            ...
            <div class="col-md-12">
                <div class="topic">
                        <h3><a title="<?php echo $newquery;?> tv shows"><?php echo $newquery;?> tv shows <i class="fa fa-angle-right ml-3" aria-hidden="true"></i></a></h3>
                </div>
                <div class="row">
                    <div class="col-md-wrap">
                        <?php 
                            $TV = unserialize( gsilvers_data_search_tv(limit_word($newquery, 3),$page) );
