...
function get_headmenu( ) {
        if (file_exists( $_SERVER['DOCUMENT_ROOT'] . '/themes/'. config('sitethemes') . '/headmenu.php' ))
                include ( $_SERVER['DOCUMENT_ROOT'] . '/themes/' . config('sitethemes') . '/headmenu.php' );
}
function get_headmenus( ) {
        if (file_exists( $_SERVER['DOCUMENT_ROOT'] . '/themes/'. config('sitethemes') . '/headmenus.php' ))
                include ( $_SERVER['DOCUMENT_ROOT'] . '/themes/' . config('sitethemes') . '/headmenus.php' );
}
function _seo( $query ) {
        if ( config('_seo') == 'true' ):
