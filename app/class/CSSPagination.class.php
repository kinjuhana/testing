...
class CSSPagination
{
	...
	public function showPage()
	{
		...
		{
			if ($page > 1) 
				$pagination .= '<li class="page-item"><a class="page-link" rel="nofollow" href='.$this->website.$this->separate.'page='.$prev.'> <i class="fa fa-angle-left"></i> prev</a></li>';
			else
				$pagination .= '<li class="page-item disabled"><a class="page-link" rel="nofollow" href="#"><i class="fa fa-angle-left"></i> prev</a></li>';
			...
			{	
				...
				{
					if ($counter == $page)
						$pagination .= ' <li class="active"><a class="page-link" rel="nofollow" href="#">'.$counter.'</a></li>';
					else
		...
		if ($page < $counter - 1) 
			$pagination .= '<li class="page-item"><a class="page-link" rel="nofollow" href="'.$this->website.$this->separate.'page='.$next.'">next <i class="fa fa-angle-right"></i></a></li>';
		else
			$pagination .= "<li class=\"page-item disabled\"><a class=\"page-link\" rel=\"nofollow\" href=\"#\">next <i class=\"fa fa-angle-right\"></i></a></li>";
		$pagination .= "</ul></div>\n";			
		}	
